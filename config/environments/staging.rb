...
Rails.application.configure do
  ...
  # Use a different cache store in staging (Redis for better performance)
  ...
  config.active_job.queue_name_prefix = "minesweeper_ror_staging"
  ...
  # Enable detailed query logging in staging for debugging
  config.active_record.verbose_query_logs = ENV["ENABLE_QUERY_LOGS"].present?
  
  # Staging-specific configurations
  # Show more detailed errors in staging than production
  config.consider_all_requests_local = ENV["SHOW_DETAILED_ERRORS"].present?
  
  # Enable performance profiling in staging
  # config.active_support.report_deprecations = true
  
  # Configure Action Cable for staging
